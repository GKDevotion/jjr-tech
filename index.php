...
?>
                        ...
                        <div class="hero-content style1">
                           ...
                           <div class="contact-meta">
                              <div class="btn-wrapper">
                                 <a href="contact.php" class="gt-btn style4">Get Started →<i class="fa-sharp fa-regular fa-arrow-right-long"></i></a>
                              </div>

                              <div class="btn-wrapper">
                                 <a href="service.php" class="gt-btn style1">Explore Services → <i class="fa-sharp fa-regular fa-arrow-right-long"></i></a>
                              </div>
                           </div>
                        </div>
                     </div>
   ...
   <div class="brand-slider-section fix d-none">
